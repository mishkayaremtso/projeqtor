...
This amount is visible on all budget items.
  ...
  .. compound:: Budget expense detail
...
* Click on |Delete| to delete the detail line.
 ...
 .. compound:: Financial expenses synthesis
...
.. rubric:: project expenses and generate expense
...
.. list-table::  Required field |ReqFieldLegend|
   ...
   * - |RequiredField| External reference
     - :term:`External reference` of the provider's invoice
   * - :term:`Description`
     - Complete description of the expense.
...
* Click on |Mark| to remove a term.
